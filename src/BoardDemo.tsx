...
function BoardDemo() {
  ...
  return (
    <div className="app">
      ...
      >
        <div>
          <h3 style={{ textAlign: "center" }}>Your Board (with ships visible)</h3>
          <Board boardData={createDemoBoard()} label="Your Board" isOpponent={false} disabled={true} />
        </div>

        <div>
          <h3 style={{ textAlign: "center" }}>Opponent Board (ships hidden, clickable)</h3>
          <Board
      ...
      >
        ...
        <ul style={{ lineHeight: "1.8" }}>
          <li>
            <strong>Dark Green Cells</strong> - Your ships (only visible on your board)
          </li>
          <li>
        ...
        <p style={{ marginTop: "1rem" }}>
          <em>Open browser console to see click events on the opponent board.</em>
        </p>
      </div>
    </div>
  );
